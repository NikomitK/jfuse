...
public class fuse_context {
    ...
    private static final OfShort umask$LAYOUT = (OfShort)$LAYOUT.select(groupElement("umask"));
     ...
     * }
     */
    public static final OfShort umask$layout() {
        return umask$LAYOUT;
    }
     ...
     * }
     */
    public static short umask(MemorySegment struct) {
     ...
     * }
     */
    public static void umask(MemorySegment struct, short fieldValue) {
